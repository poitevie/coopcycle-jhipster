...
describe('Client e2e test', () => {
  ...
  const clientSample = { idC: 'Rustic', firstnameC: 'Ujaq', lastnameC: 'Qmh', emailC: 'CwNWg@XoW_\\)Ij', addressC: 'Handmade Garden' };
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      ...
      cy.get(`[data-cy="emailC"]`).type('8bI@NP1x\fokmd').should('have.value', '8bI@NP1x\fokmd');
